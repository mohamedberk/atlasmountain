            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  style={{ '--hover-color': ACCENT_RED } as React.CSSProperties}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = ACCENT_RED
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-neutral-600">
                <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#ff2828]/10 flex items-center justify-center mt-0.5">
                  <MapPin className="w-4 h-4 text-[#ff2828]" />
                </div>
              ...
              <li>
                ...
                >
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#ff2828]/10 flex items-center justify-center group-hover:bg-[#ff2828]/20 transition-colors">
                    <Phone className="w-4 h-4 text-[#ff2828]" />
                  </div>
              ...
              <li>
                ...
                >
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#ff2828]/10 flex items-center justify-center group-hover:bg-[#ff2828]/20 transition-colors">
                    <Mail className="w-4 h-4 text-[#ff2828]" />
                  </div>
